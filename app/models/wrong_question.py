...
class WrongQuestion(Base, TimestampMixin):
    ...
    recognition_pipeline = Column(String(64), nullable=True, index=True)
    mark_status = Column(String(32), nullable=True)
    question_evidence_status = Column(String(32), nullable=True)
    answer_status = Column(String(32), nullable=True, index=True)
